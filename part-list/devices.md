...
Recommending cheap Chinese non branded keyboards
...
Recommending Razer Basilisk v3 <mark style="color:green;">verified non unique serial number.</mark>
...
* Makcu can spoof your mouse serial to null (using custom script).

## Headset

Recommending Logitech G435 <mark style="color:green;">verified non unique serial number.</mark>
...
Recommending Corsair Vengeance ram <mark style="color:green;">all modules have no unique serial number.</mark>

* [Corsair Vengeance DDR4](https://www.pricerunner.com/pl/38-5134118/RAM-Memory/Corsair-Vengeance-LPX-Black-DDR4-3600MHz-2x32GB-\(CMK64GX4M2D3600C18\)-Compare-Prices)
* [Corsair Vengeance DDR5](https://www.pricerunner.com/pl/38-3258453027/RAM-Memory/Corsair-DDR5-6000MHz-2x16GB-\(CMK32GX5M2B6000Z30\)-Compare-Prices)
* G.Skill Trident has no serials <mark style="color:$danger;">not 100% verified</mark>
...
* [TP-Link UE300](https://www.pricerunner.com/pl/117-3076573/Network-Cards-Bluetooth-Adapters/TP-Link-UE300-Compare-Prices) (<mark style="color:$warning;">has serial number, but cheap replacement</mark>)
* [Amazon basic](https://www.amazon.se/Amazon-Basics-Gigabit-Ethernet-internetadapter/dp/B00M77HMU0) (<mark style="color:$warning;">has serial number, but cheap replacement</mark>)

## TPM Spoofing

This is harder since it depends what motherboard you have, you will have to do manual searching for a chip that fits your motherboard.
